...
<div id="sub">
    ...
    <section class="cate3">
        <aside>
            ...
            <ul class="lnb">
                <li class="${cate eq 'story' ? 'on':''}"><a href="/Farmstory2/board/list.do?group=croptalk&cate=story">농작물 이야기</a></li>
        ...
        <article>
            <nav>
                <img src="/Farmstory2/img/sub_nav_tit_cate3_${cate}.png" alt="농작물 이야기"/>
                <p>
                    HOME > 농작물 이야기 > 
